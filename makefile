...
all:	analizer
analizer: program.o plotno.o pixel.o maska.o utils.o maski_rozne.o
	g++ $(FLAGS) program.o plotno.o pixel.o maski_rozne.o maska.o utils.o -o analizer $(LIBS)
...
maski_rozne.o: maski_rozne.cpp maski_rozne.hpp
	g++ -c $(FLAGS) maski_rozne.cpp -o maski_rozne.o
